...
void initializeRoutes({
  ...
  String? policyAssitWidgetName,
  String? policyAssitWidgetPath,
  String? planRecommendadtionWidgetName,
  String? planRecommendadtionWidgetPath,
  String? comparePlansWidgetName,
  String? comparePlansWidgetPath,
}) {
  HomePageWidget.maybeSetRouteName(homePageWidgetName);
  HomePageWidget.maybeSetRoutePath(homePageWidgetPath);
  PolicyAssitWidget.maybeSetRouteName(policyAssitWidgetName);
  PolicyAssitWidget.maybeSetRoutePath(policyAssitWidgetPath);
  PlanRecommendadtionWidget.maybeSetRouteName(planRecommendadtionWidgetName);
  PlanRecommendadtionWidget.maybeSetRoutePath(planRecommendadtionWidgetPath);
  ComparePlansWidget.maybeSetRouteName(comparePlansWidgetName);
  ComparePlansWidget.maybeSetRoutePath(comparePlansWidgetPath);
}
...
class RootPageContext {
  ...
  static bool isInactiveRootPage(BuildContext context) {
    ...
    final location = GoRouterState.of(context).name.toString();
    return isRootPage &&
        location != '/' &&
